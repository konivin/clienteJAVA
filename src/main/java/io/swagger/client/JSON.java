...
public class JSON {
    ...
    private boolean validate(String body) throws ApiException{
        ErrorResponse errorResponse = gson.fromJson(body, ErrorResponse.class);
        if(errorResponse != null && errorResponse.getMensaje() != null){
            throw new ApiException(errorResponse.getMensaje());
        }
        JsonObject jsonObject = gson.fromJson(body, JsonObject.class);
        Set<String> propiedadesJson = jsonObject.keySet();
        for(String propiedad: propiedadesJson){
            try {
                Integer.valueOf(propiedad);
                throw new ApiException("Código: "+ propiedad +" consultado errado!");
