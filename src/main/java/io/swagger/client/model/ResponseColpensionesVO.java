...
/**
 * Colombia -  92541475 - Certificado de afiliacion Colpensiones
 */
@Schema(description = "Colombia -  92541475 - Certificado de afiliacion Colpensiones")
...
public class ResponseColpensionesVO {
  ...
  public ResponseColpensionesVO personaVO(PersonaVO personaVO) {
  ...
  **/
  ...
  public ResponseColpensionesVO detalle(String detalle) {
    this.detalle = detalle;
    return this;
  }

   /**
   * Detalle de la afiliación o estado en Colpensiones.
   * @return detalle
  **/
  @Schema(required = true, description = "Detalle de la afiliación o estado en Colpensiones.")
  ...
  public ResponseColpensionesVO fechaConsulta(String fechaConsulta) {
  ...
  **/
  ...
  public ResponseColpensionesVO fuenteFallo(FuenteFalloEnum fuenteFallo) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ResponseColpensionesVO responseColpensionesVO = (ResponseColpensionesVO) o;
    return Objects.equals(this.personaVO, responseColpensionesVO.personaVO) &&
        Objects.equals(this.detalle, responseColpensionesVO.detalle) &&
        Objects.equals(this.fechaConsulta, responseColpensionesVO.fechaConsulta) &&
        Objects.equals(this.fuenteFallo, responseColpensionesVO.fuenteFallo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(personaVO, detalle, fechaConsulta, fuenteFallo);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResponseColpensionesVO {\n");
